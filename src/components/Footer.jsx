...
export default function Footer() {
  ...
  {/* Content */}
  <div className="relative z-20 container mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-14">

    {/* Logo */}
    <div className="w-[150px] mt-2 mx-auto sm:mx-0">
      <img src={logo} alt="Cherii" className="mb-2" />
    </div>

    {/* Quick Links */}
    <div className="w-full sm:w-[250px] mx-auto sm:mx-0 lg:mx-20 text-center lg:text-left">
      <h3 className="font-bold text-xl mb-4 lg:mb-8">Quick Links</h3>
      <ul className="space-y-2 lg:space-y-3 font-semibold">
    ...
    {/* Shop */}
    <div className="mx-auto sm:mx-0 lg:mx-20 text-center lg:text-left">
      <h3 className="font-bold text-xl mb-4 lg:mb-8">Shop</h3>
      <ul className="space-y-2 lg:space-y-3 font-semibold">
    ...
    <div className="text-center lg:text-left">
      <h3 className="font-bold text-xl mb-4 lg:mb-8">Contact</h3>
      <ul className="space-y-2 lg:space-y-3 font-semibold">
        <li className="flex flex-col lg:flex-row lg:items-start lg:gap-2">
          <img src={locationImg} alt="Location" className="w-6 h-6 mx-auto lg:mx-0" />
          <span>No.45, Anna Salai, T. Nagar, Chennai - 600 017</span>
        </li>
        <li className="flex flex-col lg:flex-row lg:items-center lg:gap-2">
          <img src={mailImg} alt="Email" className="w-6 h-6 mx-auto lg:mx-0" />
          <a href="mailto:info@cherii.com" className="hover:underline">info@cherii.com</a>
        </li>
        <li className="flex flex-col lg:flex-row lg:items-center lg:gap-2">
          <img src={phoneImg} alt="Phone" className="w-6 h-6 mx-auto lg:mx-0" />
      ...
      <div className="mt-4">
        ...
        <div className="flex justify-center lg:justify-start gap-4">
          <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer">
            <img src={insta} alt="Instagram" className="w-10 h-10 rounded cursor-pointer" />
          </a>
          <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer">
            <img src={linkedIn} alt="LinkedIn" className="w-10 h-10 rounded cursor-pointer" />
          </a>
          <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer">
            <img src={facebook} alt="Facebook" className="w-10 h-10 rounded cursor-pointer" />
          </a>
          <a href="https://www.youtube.com" target="_blank" rel="noopener noreferrer">
            <img src={youtube} alt="YouTube" className="w-10 h-10 rounded cursor-pointer" />
          </a>
        </div>
      </div>
    </div>
